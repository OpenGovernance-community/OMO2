...
function initVideoPlayer() {
    ...
    const iframe = document.getElementById('missionVideoPlayer') || document.getElementById('vimeoPlayer');
    ...
    const provider = (iframe.getAttribute('data-video-provider') || (iframe.id === 'vimeoPlayer' ? 'vimeo' : '')).toLowerCase();
    const controlMode = (iframe.getAttribute('data-video-control-mode') || (iframe.id === 'vimeoPlayer' ? 'custom' : '')).toLowerCase();

    if (provider !== 'vimeo' || controlMode !== 'custom') {
