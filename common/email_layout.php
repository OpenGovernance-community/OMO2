...
<table width='640' cellpadding='0' cellspacing='0' style='max-width:640px; width:100%; background:white; border-radius:12px; overflow:hidden; box-shadow:0 16px 40px rgba(15, 23, 42, 0.08);'>
<tr>
<td style='background:" . commonMailEscape($brandColor) . "; text-align:center; padding:32px 24px; position:relative;'>
    ...
    <div style='position:relative;'>
        " . ($logoUrl !== '' ? "
        <div style='width:84px;height:84px;border-radius:12px;background:white;margin:0 auto 14px;padding:8px;box-sizing:border-box;'>
            <img src='" . commonMailEscape($logoUrl) . "' alt='' style='width:100%;height:100%;object-fit:cover;border-radius:8px;display:block;'>
        </div>
        " : "") . "
...
<td style='padding:32px 32px 28px;'>
    " . $introHtml . "
    " . $bodyHtml . "
    " . ($detailsHtml !== '' ? "<div style='margin:18px 0 0; padding:18px 20px; border:1px solid #dbe3ef; border-radius:12px; background:#f8fafc;'>" . $detailsHtml . "</div>" : "") . "
