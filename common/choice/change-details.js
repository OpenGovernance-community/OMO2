...
function detailedHolonChanges(action){
    ...
    if (action.type === 'holon.move') {
        displayChange(changes,detailTexts.parent,before.parent_label || before.parent_id,after.parent_label || after.parent_id);
        return changes;
    }
