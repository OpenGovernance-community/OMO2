...
if (!function_exists('omoTeamSourceLang')) {
    function omoTeamSourceLang(): array
    {
        ...
        $sourceLang = [
            ...
            'team.scope.global' => ['text' => 'Global', 'context' => 'Label of the global scope in the team module.'],
            'team.view.choice_aria' => ['text' => 'Choix de la vue', 'context' => 'Accessible label of the team view switcher.'],
            'team.view.cards' => ['text' => 'Cartes', 'context' => 'Cards view label in the team module.'],
            ...
            'team.action.grant_context_admin' => ['text' => 'Définir comme admin du contexte {context}', 'context' => 'Menu action used to grant context admin rights in the team module.'],
            'team.action.revoke_context_admin' => ['text' => 'Retirer le statut admin du contexte {context}', 'context' => 'Menu action used to revoke context admin rights in the team module.'],
            ...
            'team.confirm.grant_context_admin' => ['text' => 'Définir {name} comme admin du contexte {context} ?', 'context' => 'Confirmation message shown before granting context admin rights in the team module.'],
            'team.confirm.revoke_context_admin' => ['text' => 'Retirer le statut admin de {name} pour le contexte {context} ?', 'context' => 'Confirmation message shown before revoking context admin rights in the team module.'],
            ...
            'team.empty.global' => ['text' => "Aucune personne n'est encore liée à cette organisation.", 'context' => 'Empty state shown in the team module for the global scope.'],
            ...
            'team.map.empty.global' => ['text' => "Aucun membre n'a encore de position géographique dans cette organisation.", 'context' => 'Map empty state shown in the team module for the global scope.'],
            ...
            'team.member.admin_short' => ['text' => 'Admin', 'context' => 'Short admin badge shown on member cards in the team module.'],
            'team.member.admin_context' => ['text' => 'Admin du contexte', 'context' => 'Badge shown for a context admin in the team module.'],
            'team.member.admin_organization' => ['text' => "Admin de l'organisation", 'context' => 'Badge shown for an organization admin in the team module.'],
            ...
            'team.member.added' => ['text' => 'Ajout', 'context' => 'Label of the member creation date in the team module.'],
            'team.member.last_connection' => ['text' => 'Connexion', 'context' => 'Label of the member last connection date in the team module.'],
            'team.member.never' => ['text' => 'Jamais', 'context' => 'Fallback value used when a member never connected in the team module.'],
            'team.member.photo_coming' => ['text' => 'Photo à venir', 'context' => 'Placeholder label shown when a member photo is missing in the team module.'],
            ...
            'team.api.no_right_manage_admin' => ['text' => "Vous n'avez pas le droit de gérer le statut admin dans ce contexte.", 'context' => 'JSON error message returned by the team member action endpoint when the current user cannot manage admin rights in the current context.'],
            ...
            'team.api.pending_admin_invitation_not_found' => ['text' => "Aucune invitation admin en attente n'a été trouvée pour cette personne.", 'context' => 'JSON error message returned by the team member action endpoint when no pending admin invitation is found for the target user.'],
