...
if (!function_exists('omoTeamSourceLang')) {
    function omoTeamSourceLang(): array
    {
        ...
        $sourceLang = [
			...
			'team.action.email_copied' => ['text' => 'Copié', 'context' => 'Temporary confirmation shown on the Team button after copying an email address.'],
            'team.action.edit_assignment' => ['text' => 'Éditer l’affectation', 'context' => 'Menu action used to edit a member assignment in the team module.'],
            ...
            'team.confirm.remove_with_one_role' => ['text' => 'Attention : {name} sera retiré de {context} et également d’un rôle situé dans ce contexte. Continuer ?', 'context' => 'Confirmation shown before removing a member from a context and one nested role.'],
            'team.confirm.remove_with_roles' => ['text' => 'Attention : {name} sera retiré de {context} et également de {roleCount} rôles situés dans ce contexte. Continuer ?', 'context' => 'Confirmation shown before removing a member from a context and several nested roles.'],
            ...
            'team.member.contact' => ['text' => 'Contact', 'context' => 'Contact field label in the Team member card view.'],
            'team.member.focus' => ['text' => 'Focus', 'context' => 'Label of the person focus on a role member card.'],
            'team.member.time_budget_value' => ['text' => '{amount} h / {recurrence}', 'context' => 'Time budget value shown on a Team member card.'],
            'team.member.money_budget_value' => ['text' => '{amount} / {recurrence}', 'context' => 'Money budget value shown on a Team member card.'],
            'team.assignment_popup.title' => ['text' => 'Éditer l’affectation', 'context' => 'Title of the member assignment editor popup in the team module.'],
            'team.assignment_popup.for_member' => ['text' => 'Affectation de {name}', 'context' => 'Heading of the assignment editor popup in the team module.'],
            'team.assignment_popup.focus.help' => ['text' => 'Précision sur la contribution de cette personne dans ce contexte.', 'context' => 'Help text for the focus field in the assignment editor popup.'],
            'team.assignment_popup.time_budget' => ['text' => 'Budget temps', 'context' => 'Label of the time budget field in the assignment editor popup.'],
            'team.assignment_popup.time_budget.help' => ['text' => 'En heures.', 'context' => 'Help text for the time budget field in the assignment editor popup.'],
            'team.assignment_popup.money_budget' => ['text' => 'Budget argent', 'context' => 'Label of the money budget field in the assignment editor popup.'],
            'team.assignment_popup.review_date' => ['text' => 'Date limite d’affectation', 'context' => 'Assignment review deadline field in the assignment editor popup.'],
            'team.assignment_popup.review_date.help' => ['text' => 'Date à laquelle l’affectation doit être reconfirmée ou arrêtée.', 'context' => 'Help text for the assignment review deadline field in the assignment editor popup.'],
            'team.assignment_popup.recurrence' => ['text' => 'Recurrence', 'context' => 'Label of a budget recurrence selector in the assignment editor popup.'],
            'team.assignment_popup.recurrence.day' => ['text' => 'Par jour', 'context' => 'Daily budget recurrence option in the assignment editor popup.'],
            'team.assignment_popup.recurrence.week' => ['text' => 'Par semaine', 'context' => 'Weekly budget recurrence option in the assignment editor popup.'],
            ...
            'team.assignment_popup.save_success' => ['text' => 'Affectation mise à jour.', 'context' => 'Success message after saving the assignment editor popup.'],
            ...
            'team.assignment_popup.invalid_budget' => ['text' => 'Le budget doit être un nombre positif ou nul.', 'context' => 'Error shown when an assignment budget is invalid.'],
            'team.assignment_popup.invalid_recurrence' => ['text' => 'Choisissez une récurrence pour chaque budget renseigné.', 'context' => 'Error shown when a budget recurrence is invalid.'],
            'team.assignment_popup.invalid_review_date' => ['text' => 'La date limite est invalide.', 'context' => 'Error shown when the assignment review deadline is invalid.'],
            'team.assignment_popup.focus_too_long' => ['text' => 'Le focus est trop long.', 'context' => 'Error shown when the assignment focus exceeds its maximum length.'],
            'team.assignment_popup.save_failed' => ['text' => 'Impossible d’enregistrer cette affectation.', 'context' => 'Error shown when saving the assignment editor popup fails.'],
            ...
            'team.member.assignment' => ['text' => 'Affectation', 'context' => 'Label of the contextual member assignment date in the team module.'],
            'team.member.assignment_review_date' => ['text' => 'Date limite', 'context' => 'Assignment review deadline shown on a Team member card.'],
            'team.member.assignment_via' => ['text' => 'Via', 'context' => 'Label of the contextual member assignment source in the team module.'],
            'team.member.assignment_roles' => ['one' => 'Par 1 rôle', 'other' => 'Par {count} rôles', 'context' => 'Contextual member assignment detail when roles make a person a circle member.'],
