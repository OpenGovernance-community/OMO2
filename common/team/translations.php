...
if (!function_exists('omoTeamSourceLang')) {
    function omoTeamSourceLang(): array
    {
        ...
        $sourceLang = [
            ...
            'team.confirm.remove_with_one_role' => ['text' => 'Attention : {name} sera retire de {context} et egalement de 1 role situe dans ce contexte. Continuer ?', 'context' => 'Confirmation shown before removing a member from a context and one nested role.'],
            'team.confirm.remove_with_roles' => ['text' => 'Attention : {name} sera retire de {context} et egalement de {roleCount} roles situes dans ce contexte. Continuer ?', 'context' => 'Confirmation shown before removing a member from a context and several nested roles.'],
            ...
            'team.assignment_popup.title' => ['text' => 'Editer l affectation', 'context' => 'Title of the member assignment editor popup in the team module.'],
            ...
            'team.assignment_popup.focus.help' => ['text' => 'Precision sur la contribution de cette personne dans ce contexte.', 'context' => 'Help text for the focus field in the assignment editor popup.'],
            ...
            'team.assignment_popup.review_date.help' => ['text' => 'Date a laquelle l affectation doit etre reconfirmee ou arretee.', 'context' => 'Help text for the assignment review deadline field in the assignment editor popup.'],
            ...
            'team.assignment_popup.invalid_recurrence' => ['text' => 'Choisissez une recurrence pour chaque budget renseigne.', 'context' => 'Error shown when a budget recurrence is invalid.'],
