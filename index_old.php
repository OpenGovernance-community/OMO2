...
<html>
	<head>
		...
		<!-- Script Paypal -->
		<?php if (!empty($GLOBALS["paypalClientId"])): ?>
		<script src="https://www.paypal.com/sdk/js?client-id=<?=rawurlencode($GLOBALS["paypalClientId"])?>&vault=true&intent=subscription" data-sdk-integration-source="button-factory" data-namespace="paypal_sdk"></script>
