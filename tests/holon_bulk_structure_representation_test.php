...
$holonRows = array(
    ...
    array('id' => 3, 'name' => 'Role B', 'nomcomplet' => '', 'color' => '', 'color_unassigned' => '', 'IDtypeholon' => 1, 'IDholon_parent' => 2, 'IDholon_template' => 10, 'active' => 1, 'visible' => 1, 'templatename' => '', 'link' => 0),
    array('id' => 4, 'name' => 'Role A', 'nomcomplet' => '', 'color' => '', 'color_unassigned' => '', 'IDtypeholon' => 1, 'IDholon_parent' => 2, 'IDholon_template' => 11, 'active' => 1, 'visible' => 1, 'templatename' => '', 'link' => 0),
    ...
    array('id' => 10, 'name' => 'Role template', 'nomcomplet' => '', 'color' => '#abcdef', 'color_unassigned' => '#112233', 'IDtypeholon' => 1, 'IDholon_parent' => 1, 'IDholon_template' => null, 'active' => 1, 'visible' => 0, 'templatename' => 'role-template', 'link' => 1),
    array('id' => 11, 'name' => 'Visible template', 'nomcomplet' => '', 'color' => '#fedcba', 'color_unassigned' => '#445566', 'IDtypeholon' => 1, 'IDholon_parent' => 1, 'IDholon_template' => null, 'active' => 1, 'visible' => 1, 'templatename' => 'visible-template', 'link' => 0),
);
...
$representation = \dbObject\Holon::buildBulkStructureRepresentationFromRows(
    ...
    array(
        ...
        'memberCardsByHolonId' => array(
            2 => array(array('userId' => 7, 'displayName' => 'Circle member')),
            3 => array(array('userId' => 5, 'displayName' => 'Role member', 'focus' => 'Facilitation')),
        ),
    )
);
...
assertBulkStructure(empty($circle['memberCards'] ?? array()), 'Non-terminal circles must not receive member cards.');
...
assertBulkStructure(($roleA['unassignedColor'] ?? '') === '#445566', 'Template unassigned colors must be inherited.');
...
assertBulkStructure(($roleB['unassignedColor'] ?? '') === '#112233', 'Hidden template unassigned colors must be inherited.');
assertBulkStructure(($roleB['userIds'] ?? array()) === array(5), 'Direct members must be attached to their role.');
assertBulkStructure(($roleB['memberCards'][0]['displayName'] ?? '') === 'Role member', 'Terminal roles must preserve member cards.');
assertBulkStructure(($roleB['memberCards'][0]['focus'] ?? '') === 'Facilitation', 'Terminal member cards must preserve the member focus.');
