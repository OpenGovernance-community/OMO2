...
if (!function_exists('omoChecklistSourceLang')) {
    function omoChecklistSourceLang()
    {
        return [
            ...
            'checklist.error.item_holon' => ['text' => 'L espace choisi pour cette étape ou activité est invalide.', 'context' => 'Invalid process item space error.'],
            ...
            'checklist.form.responsible_help' => ['text' => 'Si aucune personne n’est choisie, la responsabilité reste portée par l espace associé.', 'context' => 'Help text for the process responsible user selector.'],
            ...
            'checklist.form.item_recurrence_help' => ['text' => 'Chaque occurrence crée un projet simple pour l espace choisi. Vous pouvez le faire apparaître en avance et définir son délai de réalisation.', 'context' => 'Explanation for independent recurring checklist item projects.'],
            ...
            'checklist.overlap.create_new' => ['text' => 'Créer une nouvelle instance', 'context' => 'Create a new parallel process instance.'],
            'checklist.overlap.block' => ['text' => 'Ne pas créer de nouvelle instance', 'context' => 'Require the open process instance to end first.'],
            'checklist.overlap.restart' => ['text' => 'Effacer les instances précédentes et recommencer', 'context' => 'Archive open process instances before creating a new one.'],
