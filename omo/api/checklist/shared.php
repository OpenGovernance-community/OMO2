...
if (!function_exists('omoChecklistSourceLang')) {
    function omoChecklistSourceLang()
    {
        return [
            ...
            'checklist.action.item_more' => ['text' => 'Autres options pour cet élément', 'context' => 'Accessible label for the extra checklist item actions menu.'],
            ...
            'checklist.action.select_checklist' => ['text' => 'Choisir une checklist...', 'context' => 'Empty option in the checklist item move picker.'],
            'checklist.action.no_target_checklist' => ['text' => 'Aucune autre checklist disponible dans ce contexte.', 'context' => 'Empty state in the checklist item move picker.'],
            'checklist.action.move_item_title' => ['text' => 'Déplacer l élément', 'context' => 'Title of the checklist item move dialog.'],
            'checklist.action.move_item_help' => ['text' => 'Choisissez la checklist qui accueillera cet élément.', 'context' => 'Help text in the checklist item move dialog.'],
            ...
            'checklist.error.item_extract_recurrence' => ['text' => 'Seul un élément récurrent d un conteneur peut être extrait.', 'context' => 'Checklist item cannot be extracted without a recurrence.'],
            'checklist.error.item_target' => ['text' => 'La checklist cible est invalide ou inaccessible.', 'context' => 'Invalid destination checklist for an item move.'],
            ...
            'checklist.form.description_placeholder' => ['text' => 'Saisissez la description de la checklist.', 'context' => 'Placeholder for the checklist HTML description editor.'],
            ...
            'checklist.form.item_description_placeholder' => ['text' => 'Saisissez la description de cette etape.', 'context' => 'Placeholder for a checklist item HTML description editor.'],
