...
if (!function_exists('omoChecklistSourceLang')) {
    function omoChecklistSourceLang()
    {
        return [
            ...
            'checklist.error.item_holon' => ['text' => 'Le rôle ou espace choisi pour cette étape ou activité est invalide.', 'context' => 'Invalid process item space error.'],
            ...
            'checklist.form.responsible_help' => ['text' => 'Si aucune personne n’est choisie, la responsabilité reste portée par le rôle ou espace associé.', 'context' => 'Help text for the process responsible user selector.'],
            ...
            'checklist.form.holon' => ['text' => 'Rôle ou espace responsable', 'context' => 'Checklist item space field.'],
