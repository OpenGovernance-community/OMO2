...
if (!function_exists('lmsRenderParcoursMissionManager')) {
    function lmsParcoursEditorSourceLang(): array
    {
        return [
            ...
            'lms.parcours_editor.common.move' => ['text' => 'Déplacer', 'context' => 'Tooltip for drag handles in the parcours editor.'],
            'lms.parcours_editor.prerequisites.title' => ['text' => 'Prérequis', 'context' => 'Section title for parcours prerequisites.'],
            'lms.parcours_editor.prerequisites.intro' => ['text' => 'Ces parcours simples doivent être terminés à 100 % avant de rendre celui-ci visible.', 'context' => 'Intro text for the parcours prerequisites section.'],
            'lms.parcours_editor.prerequisites.add' => ['text' => 'Ajouter un prérequis', 'context' => 'Button used to open the parcours prerequisite picker.'],
            'lms.parcours_editor.prerequisites.empty' => ['text' => 'Aucun prérequis n’est encore défini pour ce parcours.', 'context' => 'Empty state shown when no parcours prerequisite exists yet.'],
            'lms.parcours_editor.prerequisites.edit' => ['text' => 'Éditer le parcours', 'context' => 'Menu action used to open a prerequisite parcours in edit mode.'],
            'lms.parcours_editor.prerequisites.remove' => ['text' => 'Retirer le prérequis', 'context' => 'Menu action used to remove a prerequisite from the parcours.'],
            'lms.parcours_editor.prerequisites.required' => ['text' => '100 % requis', 'context' => 'Badge shown on prerequisite parcours cards.'],
            'lms.parcours_editor.prerequisites.picker_title' => ['text' => 'Ajouter un prérequis', 'context' => 'Title of the parcours prerequisite picker.'],
            'lms.parcours_editor.prerequisites.picker_intro' => ['text' => 'Choisissez un autre parcours simple appartenant à votre organisation.', 'context' => 'Intro text of the parcours prerequisite picker.'],
            'lms.parcours_editor.prerequisites.empty_picker' => ['text' => 'Tous les parcours éligibles sont déjà utilisés comme prérequis.', 'context' => 'Empty state shown when no parcours can be added as prerequisite.'],
            'lms.parcours_editor.prerequisites.empty_search' => ['text' => 'Aucun parcours ne correspond à cette recherche.', 'context' => 'Empty state shown when no prerequisite search result matches.'],
            'lms.parcours_editor.mission_create.title' => ['text' => 'Créer une nouvelle mission', 'context' => 'Title of the inline mission creation form in the parcours editor.'],
            'lms.parcours_editor.mission_create.intro' => ['text' => 'Renseignez les informations principales de la mission. Elle sera aussitôt ajoutée à ce parcours.', 'context' => 'Intro text of the inline mission creation form.'],
            ...
            'lms.parcours_editor.mission_create.field_resume' => ['text' => 'Résumé', 'context' => 'Label of the mission summary field in the inline mission creation form.'],
            'lms.parcours_editor.mission_create.field_video' => ['text' => 'Vidéo', 'context' => 'Label of the mission video field in the inline mission creation form.'],
            ...
            'lms.parcours_editor.mission_create.submit' => ['text' => 'Créer et ajouter', 'context' => 'Submit button of the inline mission creation form.'],
            'lms.parcours_editor.missions.title' => ['text' => 'Missions du parcours', 'context' => 'Section title for missions attached to the parcours.'],
            'lms.parcours_editor.missions.intro' => ['text' => 'Glissez les missions pour changer leur ordre, puis ajoutez-en d’autres depuis la bibliothèque existante.', 'context' => 'Intro text for the parcours missions section.'],
            'lms.parcours_editor.missions.empty' => ['text' => 'Aucune mission n’est encore rattachée à ce parcours.', 'context' => 'Empty state shown when the parcours has no mission yet.'],
            'lms.parcours_editor.missions.edit' => ['text' => 'Éditer', 'context' => 'Menu action used to edit a mission from the parcours editor.'],
            ...
            'lms.parcours_editor.missions.existing_intro' => ['text' => 'Choisissez une mission déjà créée pour la rattacher à ce parcours.', 'context' => 'Intro text of the mission picker in the parcours editor.'],
            ...
            'lms.parcours_editor.missions.search_placeholder' => ['text' => 'Titre ou résumé', 'context' => 'Search placeholder used in the mission picker.'],
            'lms.parcours_editor.missions.empty_picker' => ['text' => 'Toutes les missions disponibles sont déjà dans ce parcours.', 'context' => 'Empty state shown when no existing mission can be added.'],
            'lms.parcours_editor.missions.empty_search' => ['text' => 'Aucune mission ne correspond à cette recherche.', 'context' => 'Empty state shown when no mission search result matches.'],
            ...
            'lms.parcours_editor.pack.picker_intro' => ['text' => 'Choisissez un parcours simple appartenant à votre organisation.', 'context' => 'Intro text of the pack child picker.'],
            ...
            'lms.parcours_editor.pack.empty_search' => ['text' => 'Aucun parcours ne correspond à cette recherche.', 'context' => 'Empty state shown when no pack child search result matches.'],
        ];
    }
