...
if (!function_exists('omoBudgetSourceLang')) {
    function omoBudgetSourceLang(): array
    {
        return [
            ...
            'budget.reference.holon' => ['text' => 'Budget de l’espace', 'context' => 'Legend label for the time budget stored directly on the current space.'],
            'budget.holon_budget.title' => ['text' => 'Budget de l’espace', 'context' => 'Heading for the budget stored directly on the current space.'],
            'budget.holon_budget.description' => ['text' => 'Enveloppes directement attribuées à cet espace.', 'context' => 'Description of the direct space budget editor.'],
            ...
            'budget.holon_budget.saved' => ['text' => 'Budget de l’espace enregistré.', 'context' => 'Success message after saving direct space budgets.'],
            'budget.holon_budget.error.context' => ['text' => 'L’espace demandé est introuvable.', 'context' => 'Error returned when the space budget context cannot be resolved.'],
            'budget.holon_budget.error.forbidden' => ['text' => "Vous n’avez pas le droit de modifier le budget de cet espace.", 'context' => 'Error returned when a user cannot edit direct space budgets.'],
            ...
            'budget.holon_budget.error.save' => ['text' => 'Impossible d’enregistrer le budget de l’espace.', 'context' => 'Fallback error returned when direct space budgets cannot be saved.'],
            ...
            'budget.scope.descendants' => ['text' => 'Temps de l’espace et de tous ses descendants', 'context' => 'Scope explanation for a container space.'],
