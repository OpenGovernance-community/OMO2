            ...
            <div id="omoCalendarConnectOmo" class="generic-tabs__panel generic-form-stack" data-generic-tab-panel>
                ...
                <?php else: ?>
                    <section class="generic-form-section generic-form-section--divided generic-form-stack" data-omo-calendar-connect-details data-omo-calendar-connect-url-prefix="<?= omoApiEscape($urlPrefix) ?>">
                        <div class="generic-form-field"><label class="generic-form-label" for="omoCalendarConnectUrl"><?= omoApiEscape(omoCalendarConnectT('calendar.connect.url')) ?></label><div class="generic-control-action"><input id="omoCalendarConnectUrl" class="generic-form-control" type="text" value="<?= omoApiEscape($calDavUrl) ?>" readonly data-omo-calendar-connect-url><button type="button" class="generic-action-button generic-action-button--secondary" data-omo-calendar-connect-copy><?= omoApiEscape(omoCalendarConnectT('calendar.connect.copy')) ?></button></div></div>
                        <label class="generic-form-field"><span class="generic-form-label"><?= omoApiEscape(omoCalendarConnectT('calendar.connect.color')) ?></span><input class="generic-form-control" type="color" value="#<?= omoApiEscape($initialColor) ?>" data-omo-calendar-connect-color></label>
                    ...
                    <section class="generic-form-section generic-form-section--divided generic-form-stack"><h4 class="generic-card-title generic-card-title--small"><?= omoApiEscape(omoCalendarConnectT('calendar.connect.steps.title')) ?></h4><p class="omo-calendar-connect__message"><?= omoApiEscape(omoCalendarConnectT('calendar.connect.steps')) ?></p></section>
                <?php endif; ?>
            </div>
