...
function omoDocumentsPvEditorSourceLang(): array
{
    return [
        ...
        'documents.pv_editor.checklist.button_title' => ['text' => 'Inserer un processus', 'context' => 'Tooltip for the process insertion button in a PV point editor.'],
        'documents.pv_editor.checklist.modal_title' => ['text' => 'Inserer un processus', 'context' => 'Title of the process picker opened from a PV point editor.'],
        ...
        'documents.pv_editor.checklist.insert' => ['text' => 'Inserer le processus', 'context' => 'Button confirming insertion of a process in a PV point.'],
