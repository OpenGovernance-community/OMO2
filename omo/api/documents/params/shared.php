...
if (!function_exists('omoDocumentsParamsSourceLang')) {
    function omoDocumentsParamsSourceLang()
    {
        ...
        $sourceLang = [
            ...
            'documents.params.field.collabora_internal_url_hint' => ['text' => 'Optionnel. Utilisée par OMO pour charger la découverte lorsque Collabora est sur le même réseau privé.', 'context' => 'Hint below the internal Collabora URL field.'],
            'documents.params.field.collabora_appearance_hint' => ['text' => 'L’éditeur utilise les couleurs de cette organisation, le mode avec onglets et le thème clair ou sombre actif pour chaque utilisateur.', 'context' => 'Explanation of the Collabora appearance automatically applied by OMO.'],
            'documents.params.status.collabora_ready' => ['text' => 'Connexion Collabora configurée pour les documents bureautiques collaboratifs.', 'context' => 'Status shown when Collabora is configured.'],
            'documents.params.status.collabora_empty' => ['text' => 'Aucun serveur Collabora configuré. Le document coopératif ne sera pas proposé.', 'context' => 'Status shown when Collabora is not configured.'],
            ...
            'documents.params.feedback.collabora_invalid' => ['text' => 'L’URL publique de Collabora doit être une adresse HTTP ou HTTPS valide.', 'context' => 'Error shown for invalid Collabora URL.'],
            'documents.params.feedback.collabora_incomplete' => ['text' => 'Une URL publique Collabora est nécessaire pour activer cette intégration.', 'context' => 'Error shown when Collabora configuration is incomplete.'],
            ...
            'documents.params.feedback.collabora_cleared' => ['text' => 'Configuration Collabora supprimée.', 'context' => 'Success message returned after clearing Collabora configuration.'],
            'documents.params.field.default_edit_visibility' => ['text' => 'Édition par défaut', 'context' => 'Label of the default document edit visibility selector in Documents settings.'],
            'documents.params.field.default_visibility_hint' => ['text' => 'Valeur initiale proposée lors de la création d’un document.', 'context' => 'Hint shown below the default visibility selector in Documents settings.'],
            'documents.params.field.default_edit_visibility_hint' => ['text' => 'Définit qui peut modifier un nouveau document par défaut.', 'context' => 'Hint shown below the default edit visibility selector in Documents settings.'],
