...
if (!function_exists('omoDocumentsParamsSourceLang')) {
    function omoDocumentsParamsSourceLang()
    {
        ...
        $sourceLang = [
            'documents.params.title' => ['text' => 'Parametres Documents', 'context' => 'Title of the Documents application settings screen.'],
            'documents.params.description' => ['text' => 'Configurez ici le stockage distant utilise par l application Documents pour cette organisation.', 'context' => 'Intro text shown in the Documents application settings screen.'],
            'documents.params.status.ready' => ['text' => 'Connexion Nextcloud configuree pour les documents uploades.', 'context' => 'Status text shown when Documents Nextcloud storage is configured.'],
            'documents.params.status.empty' => ['text' => 'Aucune connexion Nextcloud configuree. Le type de document upload ne sera pas propose.', 'context' => 'Status text shown when no Documents Nextcloud storage is configured.'],
            'documents.params.status.legacy' => ['text' => 'Une ancienne configuration a ete detectee. Un enregistrement ici la migrera vers l application Documents.', 'context' => 'Hint shown when a legacy organization-level Nextcloud configuration is still used.'],
            ...
            'documents.params.field.password_hint' => ['text' => 'Utilisez de preference un mot de passe applicatif Nextcloud plutot que le mot de passe principal.', 'context' => 'Hint shown below the Nextcloud app password field.'],
            ...
            'documents.params.field.folder_hint' => ['text' => 'Optionnel. Si vide, OMO utilisera directement un dossier omo-documents a la racine du compte.', 'context' => 'Hint shown below the remote Nextcloud folder field.'],
            ...
            'documents.params.feedback.saved' => ['text' => 'Parametres Documents enregistres.', 'context' => 'Success message returned after saving the Documents application settings.'],
            'documents.params.feedback.cleared' => ['text' => 'Configuration Nextcloud supprimee.', 'context' => 'Success message returned after clearing the Documents Nextcloud configuration.'],
            ...
            'documents.params.error.login' => ['text' => 'Connectez-vous pour acceder a ce panneau.', 'context' => 'Error shown when the Documents application settings screen is opened while logged out.'],
            ...
            'documents.params.error.forbidden' => ['text' => 'Activez le mode admin de cette organisation pour modifier les parametres Documents.', 'context' => 'Error shown when the current user is not allowed to manage Documents application settings.'],
            ...
            'documents.params.error.save_failed' => ['text' => 'Impossible d enregistrer les parametres Documents pour le moment.', 'context' => 'Error returned when saving the Documents application settings failed.'],
            'documents.params.error.method' => ['text' => 'Methode non autorisee.', 'context' => 'Error returned when the save endpoint receives an unsupported HTTP method.'],
        ];
