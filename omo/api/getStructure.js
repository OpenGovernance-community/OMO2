...
window.commonPageScripts["/omo/api/getStructure.js"] = function (pageConfig, pageScript) {
(function () {

const structureTranslations = pageConfig.structureTranslations;
...
$(document)
  ...
  .on("click.omoStructureExportFormat", "[data-omo-structure-export-format-button]", function (event) {
    ...
    const structureDataUrl = pageConfig.structureDataUrl;
    const initialCid = (function () {
      const requestedCid = pageConfig.requestedCid;
      if (requestedCid > 0) {
        return requestedCid;
      }
    ...
    const canCreateShareLink = pageConfig.canCreateShareLink;
    const canExportStructure = pageConfig.canExportStructure;
    let root = null;
