...
if (!function_exists('omoProjectsSourceLang')) {
    function omoProjectsSourceLang()
    {
        return [
            ...
            'projects.detail.events.coming_soon' => ['text' => 'Les événements associés seront bientôt disponibles.', 'context' => 'Placeholder in the project event tab before its content is implemented.'],
