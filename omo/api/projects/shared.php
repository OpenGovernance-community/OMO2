...
if (!function_exists('omoProjectsSourceLang')) {
    function omoProjectsSourceLang()
    {
        return [
            ...
            'projects.chat.placeholder' => ['text' => 'Ecrire un message...', 'context' => 'Placeholder for the project chat composer.'],
            ...
            'projects.detail.events.edit' => ['text' => "Editer l'événement", 'context' => 'Menu action opening the editor for an associated project event.'],
