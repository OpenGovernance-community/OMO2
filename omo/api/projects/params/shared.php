...
if (!function_exists('omoProjectsParamsSourceLang')) {
    function omoProjectsParamsSourceLang()
    {
        return [
            ...
            'projects.params.depth_help' => ['text' => 'Ce réglage réduit le score d’un projet sans parent lorsqu’il se trouve plus bas dans la structure des espaces. Il ne s’applique pas aux chaînes ancrées dans l’espace racine. Saisissez 0 pour le désactiver.', 'context' => 'Plain language explanation of the depth penalty.'],
