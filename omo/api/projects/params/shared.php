...
if (!function_exists('omoProjectsParamsSourceLang')) {
    function omoProjectsParamsSourceLang()
    {
        return [
            ...
            'projects.params.description' => ['text' => "Réglez ici le calcul d'importance stratégique partagé par les projets de cette organisation.", 'context' => 'Projects application settings description.'],
            ...
            'projects.params.unchanged' => ['text' => "Aucun paramètre de calcul n'a changé.", 'context' => 'Projects application settings unchanged feedback.'],
