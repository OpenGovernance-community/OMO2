...
if (!function_exists('omoProjectsParamsSourceLang')) {
    function omoProjectsParamsSourceLang()
    {
        return [
            ...
            'projects.params.depth_help' => ['text' => 'Ce réglage réduit le score d’un projet sans parent lorsqu’il se trouve plus bas dans la structure des cercles et rôles. Il ne s’applique pas aux chaînes ancrées dans l’espace racine. Saisissez 0 pour le désactiver.', 'context' => 'Plain language explanation of the depth penalty.'],
            ...
            'projects.params.depth_penalty_hint' => ['text' => "Applique exp(-pénalité × profondeur) uniquement au projet racine d’une chaîne non ancrée dans l’espace racine. Zéro désactive cette pénalité.", 'context' => 'Projects root project hierarchy depth penalty help.'],
