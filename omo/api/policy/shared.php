...
if (!function_exists('omoPolicySourceLang')) {
    function omoPolicySourceLang()
    {
        return [
            ...
            'policy.empty.local' => ['text' => 'Aucune regle definie dans cet espace.', 'context' => 'Empty policy list for locally defined rules.'],
            'policy.empty.contextual' => ['text' => 'Aucune regle ne s applique a cet espace.', 'context' => 'Empty policy list for applicable rules.'],
            'policy.empty.global' => ['text' => 'Aucune regle dans cette organisation.', 'context' => 'Empty organization policy list.'],
