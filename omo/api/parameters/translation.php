...
function omoHolonTemplateSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.holon_templates.property.help.list_authority' => ['text' => 'Les autorites sont creees depuis la fiche de chaque holon, avec une autorite parente existante.', 'context' => 'Help text shown for authority list properties in the holon template editor.'],
