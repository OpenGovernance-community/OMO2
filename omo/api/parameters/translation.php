...
function omoParametersIndexSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.index.card.application.forbidden' => ['text' => 'Activez le mode {adminLabel} de l organisation pour modifier les paramètres de {applicationName}.', 'context' => 'Card description shown when the current user cannot manage an installed application settings screen.'],
            'parameters.index.card.holon_templates.title' => ['text' => 'Modèles d’espaces', 'context' => 'Card title used to open the space template settings editor from the settings hub.'],
...
function omoHolonTemplateSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.holon_templates.error.organization_not_found' => ['text' => "L'organisation demandée est introuvable.", 'context' => 'Error shown when the selected organization cannot be loaded in the holon template editor.'],
            'parameters.holon_templates.error.structure_required' => ['text' => "Les modèles d’espaces sont disponibles uniquement lorsqu’une structure existe et que l’app Structure est active.", 'context' => 'Error shown when the structure app is not available for the space template editor.'],
        ...
        'parameters.holon_templates.error.admin_mode_required' => ['text' => "Activez le mode Admin de l'organisation pour utiliser cet éditeur.", 'context' => 'Error shown when an organization admin has not enabled admin mode for the holon template editor.'],
            'parameters.holon_templates.error.discovery_mode' => ['text' => 'Les modèles d’espaces ne sont pas disponibles en mode découverte.', 'context' => 'Error shown when the space template editor is unavailable in discovery mode.'],
        'parameters.holon_templates.header.organization_title' => ['text' => "Propriétés de l'organisation", 'context' => 'Header title shown in organization definition mode for the holon template editor.'],
            'parameters.holon_templates.header.organization_description' => ['text' => "Modifiez ici les propriétés, illustrations et réglages locaux de l’espace d’organisation, même lorsqu’il ne s’agit pas d’un modèle.", 'context' => 'Header description shown in organization definition mode for the space template editor.'],
        ...
        'parameters.holon_templates.hero.current_context' => ['text' => 'Contexte actuel', 'context' => 'Eyebrow shown in the sidebar hero of the holon template editor.'],
            'parameters.holon_templates.hero.definition_mode' => ['text' => 'Ce panneau agit comme un éditeur de définitions locales pour cet espace réel.', 'context' => 'Sidebar description shown in organization definition mode for the space template editor.'],
        ...
        'parameters.holon_templates.action.resize_columns' => ['text' => 'Ajuster la largeur des colonnes', 'context' => 'Accessible label for the draggable separator between the template tree and editor columns.'],
            'parameters.holon_templates.tree.current_holon' => ['text' => 'Espace édité', 'context' => 'Sidebar tree title shown in organization definition mode for the space template editor.'],
        ...
        'parameters.holon_templates.form.new_model_description' => ['text' => "Choisissez un type de base, sa place dans l'arborescence et les propriétés qu'il transmettra.", 'context' => 'Form description shown when creating a new holon template.'],
            'parameters.holon_templates.section.holon' => ['text' => 'Espace', 'context' => 'Section title shown in organization definition mode for the space template editor.'],
        ...
        'parameters.holon_templates.field.inherits_from' => ['text' => 'Hérite de', 'context' => 'Label of the parent template select in the holon template editor.'],
            'parameters.holon_templates.field.associated_holon' => ['text' => 'Associé à l’espace', 'context' => 'Label of the structural space a template is associated with in the space template editor.'],
        ...
        'parameters.holon_templates.flag.admin_parent_help' => ['text' => 'Les {adminLabel} de ce role sont aussi {adminLabel} du cercle parent.', 'context' => 'Help text for the parent administrator role template flag.'],
        ...
        'parameters.holon_templates.permission.direct_children' => ['text' => 'Enfants directs', 'context' => 'Permission scope label used for direct children of the current circle in the holon template editor.'],
        'parameters.holon_templates.permission.parent_circle_elements' => ['text' => 'Enfants du cercle englobant', 'context' => 'Permission scope label used for direct children of the containing circle in the holon template editor.'],
        ...
        'parameters.holon_templates.property.list_item_type' => ['text' => 'Type des éléments de liste', 'context' => 'Field label used to choose the item type of a list property in the holon template editor.'],
            'parameters.holon_templates.property.allowed_holon_types' => ['text' => 'Types d’espaces autorisés', 'context' => 'Field label used to restrict allowed space types in a list property.'],
        ...
        'parameters.holon_templates.property.detail_fallback' => ['text' => 'Élément', 'context' => 'Fallback title used for a detailed list item preview in the holon template editor.'],
            'parameters.holon_templates.property.help.default' => ['text' => 'Si cette valeur reste vide, chaque espace dérivé pourra définir librement son contenu.', 'context' => 'Default help text shown under property value editors in the space template editor.'],
        ...
        'parameters.holon_templates.property.help.list_detail' => ['text' => 'Chaque ligne contient un titre et une description. Laissez vide pour ne rien imposer.', 'context' => 'Help text shown for detailed list properties in the holon template editor.'],
            'parameters.holon_templates.property.help.list_holon' => ['text' => 'Cochez les espaces de base à inclure dans ce template. Les instances pourront ensuite en ajouter.', 'context' => 'Help text shown for space list properties in the space template editor.'],
        'parameters.holon_templates.property.help.list_project' => ['text' => 'Cochez les projets a inclure dans cette liste.', 'context' => 'Help text shown for project list properties in the holon template editor.'],
            'parameters.holon_templates.property.help.list_authority' => ['text' => 'Les autorités locales définies ici sont instanciées automatiquement sur chaque espace utilisant ce modèle.', 'context' => 'Help text shown for authority list properties in the space template editor.'],
        ...
        'parameters.holon_templates.form.new_model_description_short' => ['text' => 'Choisissez son type de base puis ajoutez les propriétés à transmettre.', 'context' => 'Short form description shown when editing a new holon template after selection changes.'],
            'parameters.holon_templates.form.welcome_title' => ['text' => 'Gérez vos modèles d’espaces', 'context' => 'Welcome title shown before a template is selected in the space template editor.'],
