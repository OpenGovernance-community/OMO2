...
function omoParametersIndexSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.index.card.export.eyebrow' => ['text' => 'Données', 'context' => 'Small eyebrow label shown on the organization export card.'],
        'parameters.index.card.export.description' => ['text' => 'Exporter la structure et les données choisies de {organizationName} dans un fichier JSON réutilisable.', 'context' => 'Card description used when the current user can export the organization.'],
        ...
        'parameters.index.card.application.description' => ['text' => 'Configurer les options et intégrations de {applicationName} pour {organizationName}.', 'context' => 'Card description used to open an installed application settings screen from the settings hub.'],
...
function omoServerEnvSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.server_env.field.ETHERCALC_INTERNAL_URL.help' => ['text' => 'Optionnel. Utilisé uniquement par le serveur OMO pour joindre EtherCalc dans le même réseau. Laissez vide dans les autres cas.', 'context' => 'Help text of the ETHERCALC_INTERNAL_URL field in the server environment editor.'],
        ...
        'parameters.server_env.field.SPACEDECK_INTERNAL_URL.help' => ['text' => 'Optionnel. Utilisé par OMO pour créer et supprimer les tableaux. Laissez vide pour utiliser l’URL publique.', 'context' => 'Help text of the SPACEDECK_INTERNAL_URL field in the server environment editor.'],
        ...
        'parameters.server_env.field.SPACEDECK_PROVISIONING_TOKEN.help' => ['text' => 'Jeton privé configuré sur le VPS. Il permet à OMO de créer et supprimer les tableaux.', 'context' => 'Help text of the SPACEDECK_PROVISIONING_TOKEN field in the server environment editor.'],
        'parameters.server_env.field.SPACEDOCK_EXTERNAL_ACCESS_SECRET.label' => ['text' => 'Clé de signature des accès', 'context' => 'Label of the SPACEDOCK_EXTERNAL_ACCESS_SECRET field in the server environment editor.'],
        'parameters.server_env.field.SPACEDOCK_EXTERNAL_ACCESS_SECRET.help' => ['text' => 'Clé privée longue et aléatoire, utilisée par OMO pour signer les accès de lecture et d’édition.', 'context' => 'Help text of the SPACEDOCK_EXTERNAL_ACCESS_SECRET field in the server environment editor.'],
