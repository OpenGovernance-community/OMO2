...
function omoHolonTemplateSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.holon_templates.permission.direct_children' => ['text' => 'Enfants directs', 'context' => 'Permission scope label used for direct children of the containing circle in the holon template editor.'],
        'parameters.holon_templates.permission.parent_circle_elements' => ['text' => 'Enfants directs', 'context' => 'Legacy permission scope label used for direct children of the containing circle in the holon template editor.'],
