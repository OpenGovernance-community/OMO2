...
function omoParametersIndexSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.index.card.export.forbidden' => ['text' => "Vous devez etre admin de l'organisation pour exporter ses donnees.", 'context' => 'Card description shown when the current user cannot export the organization.'],
        ...
        'parameters.index.card.application.forbidden' => ['text' => 'Activez le mode admin de l organisation pour modifier les parametres de {applicationName}.', 'context' => 'Card description shown when the current user cannot manage an installed application settings screen.'],
