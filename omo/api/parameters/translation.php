...
function omoServerEnvSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.server_env.action.test_connection' => ['text' => 'Tester la connexion', 'context' => 'Button used to test the current Etherpad or EtherCalc server settings before saving them.'],
