...
function omoParametersIndexSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.index.card.profile.eyebrow' => ['text' => 'Mon compte', 'context' => 'Small eyebrow label shown on the profile card of the settings hub.'],
        ...
        'parameters.index.card.notifications.title' => ['text' => 'Notifications', 'context' => 'Card title used to open the personal browser notification settings from the settings hub.'],
        'parameters.index.card.notifications.eyebrow' => ['text' => 'Cet appareil', 'context' => 'Small eyebrow label shown on the personal notifications card of the settings hub.'],
        'parameters.index.card.notifications.description' => ['text' => 'Autoriser les alertes OMO sur votre telephone ou ordinateur.', 'context' => 'Card description used to open the personal browser notification settings from the settings hub.'],
        'parameters.index.card.notifications.cta' => ['text' => 'configurer', 'context' => 'Action shown on the personal notifications card of the settings hub.'],
        ...
        'parameters.index.card.organization.eyebrow' => ['text' => 'Votre structure', 'context' => 'Small eyebrow label shown on the organization card of the settings hub.'],
        ...
        'parameters.index.card.organization.admin_mode_required' => ['text' => 'Activez le mode {adminLabel} dans votre profil pour modifier cette organisation.', 'context' => 'Card description shown when an organization admin has not enabled admin mode for the organization editor.'],
        'parameters.index.card.organization.admin_mode_cta' => ['text' => 'Mode {adminLabel} requis', 'context' => 'Card action shown when admin mode is required for the organization editor.'],
        ...
        'parameters.index.card.organization.forbidden' => ['text' => "Vous devez être {adminLabel} de l'organisation pour modifier ces paramètres.", 'context' => 'Card description shown when the current user cannot edit the organization settings.'],
        'parameters.index.card.export.title' => ['text' => 'Export', 'context' => 'Card title used to open the organization export popup from the settings hub.'],
        'parameters.index.card.export.eyebrow' => ['text' => 'Donnees', 'context' => 'Small eyebrow label shown on the organization export card.'],
        'parameters.index.card.export.description' => ['text' => 'Exporter la structure et les donnees choisies de {organizationName} dans un fichier JSON reutilisable.', 'context' => 'Card description used when the current user can export the organization.'],
        'parameters.index.card.export.forbidden' => ['text' => "Vous devez être {adminLabel} de l'organisation pour exporter ses données.", 'context' => 'Card description shown when the current user cannot export the organization.'],
        'parameters.index.card.application.eyebrow' => ['text' => 'Application', 'context' => 'Small eyebrow label shown on app-specific settings cards in the settings hub.'],
        'parameters.index.card.application.description' => ['text' => 'Configurer les options et integrations de {applicationName} pour {organizationName}.', 'context' => 'Card description used to open an installed application settings screen from the settings hub.'],
        'parameters.index.card.application.forbidden' => ['text' => 'Activez le mode {adminLabel} de l organisation pour modifier les paramètres de {applicationName}.', 'context' => 'Card description shown when the current user cannot manage an installed application settings screen.'],
            'parameters.index.card.holon_templates.title' => ['text' => 'Modèles des {spaceLabels}', 'context' => 'Card title used to open the structural template settings editor from the settings hub.'],
        'parameters.index.card.holon_templates.eyebrow' => ['text' => 'Architecture', 'context' => 'Small eyebrow label shown on the holon templates card of the settings hub.'],
        'parameters.index.card.holon_templates.description' => ['text' => 'Configurer les types d’éléments et leurs propriétés pour cette organisation.', 'context' => 'Card description used to open the structural template settings editor from the settings hub.'],
        'parameters.index.card.holon_templates.admin_mode_required' => ['text' => 'Activez le mode {adminLabel} dans votre profil pour ouvrir cet éditeur.', 'context' => 'Card description shown when an organization admin has not enabled admin mode for the holon template editor.'],
        'parameters.index.card.holon_templates.admin_mode_cta' => ['text' => 'Mode {adminLabel} requis', 'context' => 'Card action shown when admin mode is required for the holon template editor.'],
        'parameters.index.card.holon_templates.discovery_mode' => ['text' => 'Cet éditeur est disponible à partir du mode Autonome.', 'context' => 'Card description shown when the holon template editor is unavailable in discovery mode.'],
        ...
        'parameters.index.card.server_admin.eyebrow' => ['text' => 'Maintenance', 'context' => 'Small eyebrow label shown on the server administration card of the settings hub.'],
...
function omoServerEnvSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.server_env.action.test_connection' => ['text' => 'Tester la connexion', 'context' => 'Button used to test a collaborative service connection before saving it.'],
        ...
        'parameters.server_env.section.etherpad.intro' => ['text' => 'Connexion globale au serveur Etherpad utilise par les documents collaboratifs.', 'context' => 'Intro of the Etherpad section in the server environment editor.'],
        'parameters.server_env.section.ethercalc.title' => ['text' => 'EtherCalc', 'context' => 'Title of the EtherCalc section in the server environment editor.'],
        'parameters.server_env.section.ethercalc.intro' => ['text' => 'Connexion globale au serveur EtherCalc utilise par les tableurs collaboratifs.', 'context' => 'Intro of the EtherCalc section in the server environment editor.'],
        'parameters.server_env.section.spacedeck.title' => ['text' => 'SpaceDeck', 'context' => 'Title of the SpaceDeck section in the server environment editor.'],
        ...
        'parameters.server_env.field.ETHERPAD_URL.label' => ['text' => 'URL du serveur Etherpad', 'context' => 'Label of the ETHERPAD_URL field in the server environment editor.'],
        'parameters.server_env.field.ETHERPAD_URL.help' => ['text' => 'Adresse de base du serveur Etherpad, sans /p/ ni /api/.', 'context' => 'Help text of the ETHERPAD_URL field in the server environment editor.'],
        'parameters.server_env.field.ETHERPAD_API_KEY.label' => ['text' => 'Cle API Etherpad', 'context' => 'Label of the ETHERPAD_API_KEY field in the server environment editor.'],
        'parameters.server_env.field.ETHERPAD_API_VERSION.label' => ['text' => 'Version de l API Etherpad', 'context' => 'Label of the ETHERPAD_API_VERSION field in the server environment editor.'],
        'parameters.server_env.field.ETHERPAD_API_VERSION.help' => ['text' => 'Version renvoyee par le point d entree /api du serveur Etherpad.', 'context' => 'Help text of the ETHERPAD_API_VERSION field in the server environment editor.'],
        'parameters.server_env.field.ETHERPAD_COOKIE_DOMAIN.label' => ['text' => 'Domaine de partage des cookies', 'context' => 'Label of the ETHERPAD_COOKIE_DOMAIN field in the server environment editor.'],
        'parameters.server_env.field.ETHERPAD_COOKIE_DOMAIN.help' => ['text' => 'Domaine commun a OMO et Etherpad, par exemple .opengov.tools. Laissez vide seulement si les deux utilisent exactement le meme host.', 'context' => 'Help text of the ETHERPAD_COOKIE_DOMAIN field in the server environment editor.'],
        'parameters.server_env.field.ETHERCALC_URL.label' => ['text' => 'URL publique EtherCalc', 'context' => 'Label of the ETHERCALC_URL field in the server environment editor.'],
        'parameters.server_env.field.ETHERCALC_URL.help' => ['text' => 'Adresse de base du serveur EtherCalc, sans le nom de la feuille.', 'context' => 'Help text of the ETHERCALC_URL field in the server environment editor.'],
        'parameters.server_env.field.ETHERCALC_INTERNAL_URL.label' => ['text' => 'URL interne EtherCalc', 'context' => 'Label of the ETHERCALC_INTERNAL_URL field in the server environment editor.'],
        'parameters.server_env.field.ETHERCALC_INTERNAL_URL.help' => ['text' => 'Optionnel. Utilisee uniquement par le serveur OMO pour joindre EtherCalc dans le meme reseau. Laissez vide dans les autres cas.', 'context' => 'Help text of the ETHERCALC_INTERNAL_URL field in the server environment editor.'],
        'parameters.server_env.field.ETHERCALC_KEY.label' => ['text' => 'Cle EtherCalc', 'context' => 'Label of the ETHERCALC_KEY field in the server environment editor.'],
        'parameters.server_env.field.SPACEDECK_URL.label' => ['text' => 'URL publique SpaceDeck', 'context' => 'Label of the SPACEDECK_URL field in the server environment editor.'],
        'parameters.server_env.field.SPACEDECK_URL.help' => ['text' => 'Adresse HTTPS ouverte dans les iframes OMO, sans le nom du tableau.', 'context' => 'Help text of the SPACEDECK_URL field in the server environment editor.'],
        'parameters.server_env.field.SPACEDECK_INTERNAL_URL.label' => ['text' => 'URL interne SpaceDeck', 'context' => 'Label of the SPACEDECK_INTERNAL_URL field in the server environment editor.'],
        'parameters.server_env.field.SPACEDECK_INTERNAL_URL.help' => ['text' => 'Optionnel. Utilisee par OMO pour creer et supprimer les tableaux. Laissez vide pour utiliser l URL publique.', 'context' => 'Help text of the SPACEDECK_INTERNAL_URL field in the server environment editor.'],
        'parameters.server_env.field.SPACEDECK_PROVISIONING_TOKEN.label' => ['text' => 'Jeton de provisioning SpaceDeck', 'context' => 'Label of the SPACEDECK_PROVISIONING_TOKEN field in the server environment editor.'],
        'parameters.server_env.field.SPACEDECK_PROVISIONING_TOKEN.help' => ['text' => 'Jeton prive configure sur le VPS. Il permet a OMO de creer et supprimer les tableaux.', 'context' => 'Help text of the SPACEDECK_PROVISIONING_TOKEN field in the server environment editor.'],
        'parameters.server_env.field.SPACEDOCK_EXTERNAL_ACCESS_SECRET.label' => ['text' => 'Cle de signature des acces', 'context' => 'Label of the SPACEDOCK_EXTERNAL_ACCESS_SECRET field in the server environment editor.'],
        'parameters.server_env.field.SPACEDOCK_EXTERNAL_ACCESS_SECRET.help' => ['text' => 'Cle privee longue et aleatoire, utilisee par OMO pour signer les acces de lecture et d edition.', 'context' => 'Help text of the SPACEDOCK_EXTERNAL_ACCESS_SECRET field in the server environment editor.'],
        ...
        'parameters.server_env.field.PATREON_CONNECT_ALLOWED_ORIGINS.help' => ['text' => 'Liste d origines HTTPS séparées par des virgules, par exemple https://opengov.tools,https://beta.opengov.tools.', 'context' => 'Help text of the PATREON_CONNECT_ALLOWED_ORIGINS field in the server environment editor.'],
        ...
        'parameters.server_env.error.invalid_etherpad_url' => ['text' => 'L URL Etherpad doit etre une adresse http ou https valide.', 'context' => 'Validation error returned when the Etherpad URL is invalid in the server environment editor.'],
        'parameters.server_env.error.invalid_ethercalc_url' => ['text' => 'L URL EtherCalc doit etre une adresse http ou https valide.', 'context' => 'Validation error returned when an EtherCalc URL is invalid in the server environment editor.'],
        'parameters.server_env.error.invalid_spacedeck_url' => ['text' => 'L URL SpaceDeck doit etre une adresse http ou https valide.', 'context' => 'Validation error returned when a SpaceDeck URL is invalid in the server environment editor.'],
        'parameters.server_env.error.invalid_etherpad_api_version' => ['text' => 'La version de l API Etherpad doit etre numerique, par exemple 1.3.1.', 'context' => 'Validation error returned when the Etherpad API version is invalid in the server environment editor.'],
        'parameters.server_env.error.invalid_connection_service' => ['text' => 'Service de connexion invalide.', 'context' => 'Error returned when a connection test did not identify a supported server.'],
        'parameters.server_env.error.etherpad_connection_incomplete' => ['text' => 'Renseignez l URL, la cle API et la version de l API Etherpad avant le test.', 'context' => 'Error returned when the Etherpad connection test cannot run because settings are incomplete.'],
        'parameters.server_env.error.ethercalc_connection_incomplete' => ['text' => 'Renseignez l URL publique et la cle EtherCalc avant le test.', 'context' => 'Error returned when the EtherCalc connection test cannot run because settings are incomplete.'],
        'parameters.server_env.error.spacedeck_connection_incomplete' => ['text' => 'Renseignez l URL publique et le jeton de provisioning SpaceDeck avant le test.', 'context' => 'Error returned when the SpaceDeck connection test cannot run because settings are incomplete.'],
        'parameters.server_env.error.connection_test_failed' => ['text' => 'La connexion avec {service} a echoue{reason}.', 'context' => 'Generic error returned when a server connection test failed.'],
        'parameters.server_env.error.connection_request_failed' => ['text' => 'La requete a echoue.', 'context' => 'Fallback error returned when the connection test request did not complete.'],
        'parameters.server_env.error.curl_required' => ['text' => 'cURL est requis pour tester cette connexion.', 'context' => 'Error returned when the PHP cURL extension is unavailable for a connection test.'],
        'parameters.server_env.status.etherpad_connection_ok' => ['text' => 'Connexion Etherpad verifiee : URL, version de l API et cle sont valides.', 'context' => 'Success message returned after a valid Etherpad API connection test.'],
        'parameters.server_env.status.ethercalc_connection_ok' => ['text' => 'Connexion EtherCalc verifiee : URL publique, URL interne et cle sont valides.', 'context' => 'Success message returned after a valid EtherCalc API connection test.'],
        'parameters.server_env.status.spacedeck_connection_ok' => ['text' => 'Connexion SpaceDeck verifiee : URL et jeton de provisioning sont valides.', 'context' => 'Success message returned after a valid SpaceDeck API connection test.'],
...
function omoHolonTemplateSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.holon_templates.error.organization_not_found' => ['text' => "L'organisation demandée est introuvable.", 'context' => 'Error shown when the selected organization cannot be loaded in the holon template editor.'],
            'parameters.holon_templates.error.structure_required' => ['text' => "Les modèles de structure sont disponibles uniquement lorsqu’une structure existe et que l’app Structure est active.", 'context' => 'Error shown when the structure app is not available for the structural template editor.'],
        'parameters.holon_templates.error.admin_required' => ['text' => 'Cet éditeur est réservé aux admins de cette organisation.', 'context' => 'Error shown when a non-admin tries to access the holon template editor.'],
        'parameters.holon_templates.error.admin_mode_required' => ['text' => "Activez le mode Admin de l'organisation pour utiliser cet éditeur.", 'context' => 'Error shown when an organization admin has not enabled admin mode for the holon template editor.'],
            'parameters.holon_templates.error.discovery_mode' => ['text' => 'Les modèles de structure ne sont pas disponibles en mode découverte.', 'context' => 'Error shown when the structural template editor is unavailable in discovery mode.'],
        'parameters.holon_templates.header.organization_title' => ['text' => "Propriétés de l'organisation", 'context' => 'Header title shown in organization definition mode for the holon template editor.'],
            'parameters.holon_templates.header.organization_description' => ['text' => "Modifiez ici les propriétés, illustrations et réglages locaux de l’organisation, même sans modèle.", 'context' => 'Header description shown in organization definition mode for the structural template editor.'],
        ...
        'parameters.holon_templates.scope.contextual' => ['text' => 'Local', 'context' => 'Contextual scope label in the holon template editor.'],
        'parameters.holon_templates.scope.children' => ['text' => 'Enfants directs', 'context' => 'Current holon and direct child scope label in the holon template editor.'],
        'parameters.holon_templates.scope.descendants' => ['text' => 'Descendants', 'context' => 'Descendant scope label in the holon template editor.'],
        'parameters.holon_templates.scope.note_contextual_prefix' => ['text' => 'Mode local :', 'context' => 'Prefix shown before the contextual scope note in the holon template editor.'],
        ...
        'parameters.holon_templates.scope.note_children_prefix' => ['text' => 'Mode enfants directs :', 'context' => 'Prefix shown before the direct child scope note in the holon template editor.'],
        'parameters.holon_templates.scope.note_children' => ['text' => 'les modèles définis dans {contextName} et ses enfants directs sont affichés ici.', 'context' => 'Direct child scope note shown in the holon template editor.'],
        'parameters.holon_templates.scope.note_descendants_prefix' => ['text' => 'Mode descendants :', 'context' => 'Prefix shown before the descendant scope note in the holon template editor.'],
        'parameters.holon_templates.scope.note_descendants' => ['text' => 'les modèles définis dans {contextName} et toute sa descendance sont affichés ici.', 'context' => 'Descendant scope note shown in the holon template editor.'],
        ...
        'parameters.holon_templates.hero.current_context' => ['text' => 'Contexte actuel', 'context' => 'Eyebrow shown in the sidebar hero of the holon template editor.'],
            'parameters.holon_templates.hero.definition_mode' => ['text' => 'Ce panneau permet de modifier les définitions locales de cet élément existant.', 'context' => 'Sidebar description shown in organization definition mode for the structural template editor.'],
        'parameters.holon_templates.hero.template_mode' => ['text' => 'Créez une bibliothèque de modèles réutilisables pour les éléments de la structure.', 'context' => 'Sidebar description shown in template mode for the structural template editor.'],
        ...
        'parameters.holon_templates.action.resize_columns' => ['text' => 'Ajuster la largeur des colonnes', 'context' => 'Accessible label for the draggable separator between the template tree and editor columns.'],
            'parameters.holon_templates.tree.current_holon' => ['text' => 'Élément édité', 'context' => 'Sidebar tree title shown in organization definition mode for the structural template editor.'],
        ...
        'parameters.holon_templates.form.new_model_description' => ['text' => "Choisissez un type de base, sa place dans l'arborescence et les propriétés qu'il transmettra.", 'context' => 'Form description shown when creating a new holon template.'],
            'parameters.holon_templates.section.holon' => ['text' => 'Élément', 'context' => 'Section title shown in organization definition mode for the structural template editor.'],
        ...
        'parameters.holon_templates.field.admin_min' => ['text' => 'Nombre minimum de {adminLabel}', 'context' => 'Label for the minimum number of administrators on a holon template.'],
        'parameters.holon_templates.field.admin_max' => ['text' => 'Nombre maximum de {adminLabel}', 'context' => 'Label for the maximum number of administrators on a holon template.'],
        'parameters.holon_templates.field.admin_max_placeholder' => ['text' => 'sans limite', 'context' => 'Placeholder for an unlimited administrator maximum.'],
        'parameters.holon_templates.field.admin_bound_inherited_placeholder' => ['text' => 'Hérité ({value})', 'context' => 'Placeholder showing an administrator bound inherited from a parent template.'],
        ...
        'parameters.holon_templates.field.inherits_from' => ['text' => 'Hérite de', 'context' => 'Label of the parent template select in the holon template editor.'],
            'parameters.holon_templates.field.associated_holon' => ['text' => 'Élément associé', 'context' => 'Label of the structural element a template is associated with in the structural template editor.'],
        ...
        'parameters.holon_templates.flag.visible_help' => ['text' => 'Afficher ce modèle dans son contexte de définition.', 'context' => 'Visibility checkbox help in the structural template editor.'],
        'parameters.holon_templates.flag.mandatory' => ['text' => 'Obligatoire', 'context' => 'Mandatory checkbox label in the holon template editor.'],
        'parameters.holon_templates.flag.mandatory_help' => ['text' => 'Indique que les éléments enfants devront appliquer ce modèle.', 'context' => 'Mandatory checkbox help in the structural template editor.'],
        ...
        'parameters.holon_templates.flag.locked_name_help' => ['text' => 'Impose le même nom à toutes les instances de ce modèle.', 'context' => 'Locked name checkbox help in the holon template editor.'],
        'parameters.holon_templates.flag.unique' => ['text' => 'Unique', 'context' => 'Unique checkbox label in the holon template editor.'],
        'parameters.holon_templates.flag.unique_help' => ['text' => 'Limite à une seule application par élément parent.', 'context' => 'Unique checkbox help in the structural template editor.'],
        'parameters.holon_templates.flag.link' => ['text' => 'Lien', 'context' => 'Link checkbox label in the holon template editor.'],
        'parameters.holon_templates.flag.link_help' => ['text' => 'Associe cet élément au contexte parent.', 'context' => 'Link checkbox help in the structural template editor.'],
        'parameters.holon_templates.flag.admin_parent' => ['text' => '{adminLabel} parent', 'context' => 'Checkbox label for a role template whose administrators are administrators of the direct parent circle.'],
        'parameters.holon_templates.flag.admin_parent_help' => ['text' => 'Les {adminLabel} associés à cet élément sont aussi {adminLabel} du contexte parent.', 'context' => 'Help text for the parent administrator flag.'],
        ...
        'parameters.holon_templates.section.admin_bounds' => ['text' => '{adminLabel}', 'context' => 'Section title for administrator limits on a holon template.'],
        'parameters.holon_templates.section.admin_bounds_description' => ['text' => 'Le minimum est requis avant l’ajout d’un membre normal. Laissez le maximum vide pour ne pas limiter le nombre de {adminLabel}.', 'context' => 'Explanation for administrator limits on a holon template.'],
        ...
        'parameters.holon_templates.section.properties_description_model' => ['text' => 'Ajoutez les propriétés visibles pour les éléments issus de ce modèle.', 'context' => 'Properties section description shown in template mode for the structural template editor.'],
        ...
        'parameters.holon_templates.section.permissions_description' => ['text' => 'Activez ici les droits portés par ce modèle et choisissez leurs portées.', 'context' => 'Permissions section description in the holon template editor.'],
        ...
        'parameters.holon_templates.section.appearance_description' => ['text' => "La couleur et l'icône viennent après la définition des propriétés.", 'context' => 'Appearance section description in the holon template editor.'],
        'parameters.holon_templates.field.color' => ['text' => 'Couleur', 'context' => 'Color field label in the holon template editor.'],
        'parameters.holon_templates.field.unassigned_color' => ['text' => 'Si non attribué', 'context' => 'Unassigned role color field label in the holon template editor.'],
        ...
        'parameters.holon_templates.permission.members' => ['text' => 'Membres', 'context' => 'Permission profile tab for normal holon members.'],
        'parameters.holon_templates.permission.admins' => ['text' => '{adminLabel}', 'context' => 'Permission profile tab for holon administrators.'],
        'parameters.holon_templates.permission.collective' => ['text' => 'Collectif', 'context' => 'Permission profile tab for collectively granted permissions.'],
        ...
        'parameters.holon_templates.permission.parent_circle_elements' => ['text' => 'Éléments du contexte parent', 'context' => 'Permission scope label used for direct children of the containing context in the structural template editor.'],
        ...
        'parameters.holon_templates.confirm.inheritance_change' => ['text' => "Changer l'héritage de ce modèle peut modifier ou masquer des propriétés et des valeurs sur ce modèle, ainsi que sur les modèles et éléments qui en héritent.\n\nConfirmer cette opération ?", 'context' => 'Confirmation shown before changing the inheritance of a structural template.'],
        ...
        'parameters.holon_templates.property.list_item_type' => ['text' => 'Type des éléments de liste', 'context' => 'Field label used to choose the item type of a list property in the holon template editor.'],
            'parameters.holon_templates.property.allowed_holon_types' => ['text' => 'Types d’éléments autorisés', 'context' => 'Field label used to restrict allowed structural types in a list property.'],
        'parameters.holon_templates.property.project_scope' => ['text' => 'Portée des projets', 'context' => 'Field label used to choose the holon scope of projects displayed in a project list property.'],
        'parameters.holon_templates.property.project_scope.local' => ['text' => 'Local', 'context' => 'Project list scope limited to the current holon.'],
        'parameters.holon_templates.property.project_scope.children' => ['text' => 'Enfants directs', 'context' => 'Project list scope limited to direct child holons.'],
        'parameters.holon_templates.property.project_scope.descendants' => ['text' => 'Descendants', 'context' => 'Project list scope including every descendant holon.'],
        'parameters.holon_templates.property.project_scope.global' => ['text' => 'Global', 'context' => 'Project list scope including the whole organization.'],
        'parameters.holon_templates.property.project_search' => ['text' => 'Rechercher un projet...', 'context' => 'Quick filter placeholder shown for long project lists.'],
        'parameters.holon_templates.property.project_empty' => ['text' => 'Aucun projet disponible.', 'context' => 'Empty state shown when no project matches the selected project list scope.'],
        'parameters.holon_templates.property.no_template_for_types' => ['text' => 'Aucun modèle disponible pour les types choisis.', 'context' => 'Empty state shown when no template matches the selected holon types in a list property.'],
        ...
        'parameters.holon_templates.property.detail_fallback' => ['text' => 'Élément', 'context' => 'Fallback title used for a detailed list item preview in the holon template editor.'],
            'parameters.holon_templates.property.help.default' => ['text' => 'Si cette valeur reste vide, chaque élément issu de ce template pourra définir librement son contenu.', 'context' => 'Default help text shown under property value editors in the structural template editor.'],
        ...
        'parameters.holon_templates.property.help.list_detail' => ['text' => 'Chaque ligne contient un titre et une description. Laissez vide pour ne rien imposer.', 'context' => 'Help text shown for detailed list properties in the holon template editor.'],
            'parameters.holon_templates.property.help.list_holon' => ['text' => 'Cochez les types d’éléments à inclure dans ce modèle. Les éléments qui en découlent pourront ensuite en ajouter.', 'context' => 'Help text shown for structural list properties in the structural template editor.'],
        'parameters.holon_templates.property.help.list_project' => ['text' => 'Cochez les projets à inclure dans cette liste.', 'context' => 'Help text shown for project list properties in the holon template editor.'],
            'parameters.holon_templates.property.help.list_authority' => ['text' => 'Les autorités locales définies ici sont créées automatiquement pour chaque élément utilisant ce modèle.', 'context' => 'Help text shown for authority list properties in the structural template editor.'],
        ...
        'parameters.holon_templates.form.new_model_description_short' => ['text' => 'Choisissez son type de base puis ajoutez les propriétés à transmettre.', 'context' => 'Short form description shown when editing a new holon template after selection changes.'],
            'parameters.holon_templates.form.welcome_title' => ['text' => 'Gérez les modèles de structure', 'context' => 'Welcome title shown before a template is selected in the structural template editor.'],
        'parameters.holon_templates.form.welcome_description' => ['text' => 'Sélectionnez un modèle dans la liste pour le modifier, ou créez-en un nouveau pour définir une structure réutilisable.', 'context' => 'Welcome description shown before a template is selected in the holon template editor.'],
        'parameters.holon_templates.form.welcome_action' => ['text' => 'Créer un nouveau modèle', 'context' => 'Welcome action that opens the new holon template form.'],
