...
function omoHolonTemplateSourceLang()
{
    ...
    $sourceLang = [
        ...
        'parameters.holon_templates.error.discovery_mode' => ['text' => 'Les modèles de holons ne sont pas disponibles en mode découverte.', 'context' => 'Error shown when the holon template editor is unavailable in discovery mode.'],
        ...
        'parameters.holon_templates.property.help.list_authority' => ['text' => 'Les autorites locales definies ici sont instanciees automatiquement sur chaque holon utilisant ce modele.', 'context' => 'Help text shown for authority list properties in the holon template editor.'],
        ...
        'parameters.holon_templates.form.welcome_title' => ['text' => 'Gérez vos modèles de holons', 'context' => 'Welcome title shown before a template is selected in the holon template editor.'],
