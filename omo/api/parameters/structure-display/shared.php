...
function omoStructureDisplaySourceLang(): array
{
    ...
    $sourceLang = array(
        ...
        'parameters.structure_display.description' => array('text' => 'Ces réglages s’appliquent à la grande vue Structure et à sa mini-carte.', 'context' => 'Description of the organization structure display settings editor.'),
        'parameters.structure_display.section.visibility' => array('text' => 'Visibilité', 'context' => 'Section heading for structure display visibility settings.'),
        ...
        'parameters.structure_display.field.fade_step.help' => array('text' => '0 désactive l’estompage. La valeur actuelle par défaut est 0,18.', 'context' => 'Help text for the structure depth fade step input.'),
        ...
        'parameters.structure_display.section.labels' => array('text' => 'Libellés', 'context' => 'Section heading for structure display label settings.'),
        ...
        'parameters.structure_display.field.label_auto_radius.help' => array('text' => 'S’applique aux textes affichés dans les espaces. Valeur par défaut : 18 px.', 'context' => 'Help text for the automatic label threshold input.'),
        ...
        'parameters.structure_display.field.terminal_members.label' => array('text' => 'Afficher les personnes sur les éléments terminaux sélectionnés', 'context' => 'Checkbox label enabling member avatars on selected terminal structure elements.'),
        ...
        'parameters.structure_display.status.saved' => array('text' => 'Affichage de la structure enregistré.', 'context' => 'Success message after saving structure display settings.'),
        ...
        'parameters.structure_display.error.admin_required' => array('text' => 'Cet affichage est réservé aux administrateurs de cette organisation.', 'context' => 'Error shown when a non-admin opens structure display settings.'),
