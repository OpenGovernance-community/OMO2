    ...
    function omoDecisionVoteModuleGetSourceLang()
    {
        return [
            ...
            'decisions.vote.notice.started' => [
                'text' => 'La consultation a commencé. Le titre, la description, le type et les propositions sont désormais verrouillés.',
                'context' => 'Notice shown when the core structure of a vote is locked after start.',
            ],
            ...
            'decisions.vote.field.proposals_hint' => [
                'text' => 'Ajoutez une proposition par ligne, puis réorganisez-les par glisser-déposer. Au moins deux propositions sont nécessaires pour un vote simple.',
        ...
        <section class="generic-section generic-section--stack omo-decision-vote">
                ...
                >
                    ...
                    <div class="generic-soft-panel generic-soft-panel--stack omo-decision-vote__settings-summary">
                            ...
                            <div class="omo-decision-vote__field">
                                ...
                                <div class="omo-decision-vote__readonly-stats">
                                    <span class="omo-decision-vote__readonly-stat">
                                        ...
                                        <span data-omo-decision-vote-choice-summary><?= $escape($choiceMode === 'multiple' ? t('decisions.vote.option.choice_mode.multiple', [], $lang, $sourceLang) : t('decisions.vote.option.choice_mode.single', [], $lang, $sourceLang)) ?></span>
                                    </span>
                                    <span class="omo-decision-vote__readonly-stat" data-omo-decision-vote-max-choices-summary<?= $choiceMode === 'multiple' ? '' : ' hidden' ?>>
                                        <strong><?= $escape(t('decisions.vote.field.max_choices', [], $lang, $sourceLang)) ?></strong>
                                        <span
                                            data-omo-decision-vote-max-choices-summary-value
                                            data-unlimited-label="<?= $escape(t('decisions.vote.field.max_choices_unlimited', [], $lang, $sourceLang)) ?>"
                                        ><?= $escape($maxChoices === 0 ? t('decisions.vote.field.max_choices_unlimited', [], $lang, $sourceLang) : (string)$maxChoices) ?></span>
                                    </span>
                                    <span class="omo-decision-vote__readonly-stat">
                        ...
                        <template data-omo-decision-vote-settings-template>
                            <div class="omo-decision-vote-popup generic-section generic-section--stack">
                                <div class="omo-decision-vote-popup__grid">
                    ...
                    <label class="omo-decision-vote__field">
                        ...
                        <div class="omo-decision-vote__proposal-list" data-omo-decision-vote-proposal-list>
                            ...
                            <div
                                class="omo-decision-vote__proposal-card"
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    class="generic-action-button generic-action-button--secondary omo-decision-vote__proposal-settings"
                                    data-omo-decision-vote-proposal-settings
                                    title="<?= $escape(t('decisions.vote.field.proposal_details', [], $lang, $sourceLang)) ?>"
                                    aria-label="<?= $escape(t('decisions.vote.field.proposal_details', [], $lang, $sourceLang)) ?>"
                                >&#9881;</button>

                                <button
                                    type="button"
                                    class="generic-action-button generic-action-button--secondary omo-decision-vote__proposal-remove"
            ...
            <?php else: ?>
                ...
                >
                    ...
                    <fieldset class="omo-decision-vote__fieldset">
                        ...
                        <?php else: ?>
                            ...
                            <label class="omo-decision-vote__option">
                                <input
                ...
                <div class="generic-soft-panel generic-soft-panel--stack">
                    ...
                    <div class="omo-decision-vote__readonly-list">
                        <?php foreach ($proposalObjects as $proposal): ?>
                        <div class="omo-decision-vote__readonly-item<?= in_array((int)$proposal->getId(), $selectedProposalIds, true) ? ' is-selected' : '' ?>">
                            <div>
                                <strong><?= $escape(trim((string)$proposal->get('title'))) ?></strong>
                                <?= omoDecisionRenderProposalSupplementHtml($proposal->get('description'), $proposal->get('info_url'), $escape, 'omo-decision-vote__text', 'omo-decision-vote__link') ?>
                            </div>
                        ...
                        <div class="omo-decision-vote__readonly-item<?= in_array((int)$proposal->getId(), $selectedProposalIds, true) ? ' is-selected' : '' ?>">
                            ...
                            <div class="omo-decision-vote__readonly-stats">
                                ...
                                <span class="omo-decision-vote__readonly-stat">
                                    ...
                                    <span><?= $escape(number_format($proposalVoteShare, $proposalVoteShare === floor($proposalVoteShare) ? 0 : 1, '.', '')) ?>%</span>
                                </span>
                            </div>
                            <?php endif; ?>
                        </div>
                ...
                window.omoDecisionVoteInit = function (root) {
                    ...
                    scope.querySelectorAll('[data-omo-decision-vote-form]').forEach(function (form) {
                        ...
                        const syncChoiceModeFields = function () {
                            ...
                            if (maxChoicesSummary) {
                                maxChoicesSummary.hidden = !isMultiple;
                            }
                            if (choiceSummary) {
                                choiceSummary.textContent = isMultiple
                                    ? 'Plusieurs reponses'
                                    : 'Une seule reponse';
                            }
                            if (maxChoicesSummaryValue && hiddenMaxChoicesInput) {
                                const unlimitedLabel = String(maxChoicesSummaryValue.getAttribute('data-unlimited-label') || 'Sans limite');
                                maxChoicesSummaryValue.textContent = String(hiddenMaxChoicesInput.value || '1') === '0'
                                    ? unlimitedLabel
                                    : String(hiddenMaxChoicesInput.value || '1');
                            }
                        };
                        ...
                        const createProposalCard = function (value) {
                            ...
                            card.innerHTML = ''
                                ...
                                + '</div>'
                                + '<button type="button" class="generic-action-button generic-action-button--secondary omo-decision-vote__proposal-settings" data-omo-decision-vote-proposal-settings title="' + String(payload.texts && payload.texts.proposalDetails ? payload.texts.proposalDetails : 'Details') + '" aria-label="' + String(payload.texts && payload.texts.proposalDetails ? payload.texts.proposalDetails : 'Details') + '">&#9881;</button>'
                                + '<button type="button" class="generic-action-button generic-action-button--secondary omo-decision-vote__proposal-remove" data-omo-decision-vote-proposal-remove>' + String(payload.texts && payload.texts.proposalRemove ? payload.texts.proposalRemove : 'Supprimer') + '</button>';
