...
if (!function_exists('omoDecisionVoteModuleGetSourceLang')) {
    function omoDecisionVoteModuleGetSourceLang()
    {
        return [
            ...
            'decisions.vote.field.question_settings' => [
                'text' => 'Paramètres de la question',
                'context' => 'Section title for settings specific to one question.',
            ],
            ...
            'decisions.vote.field.allow_anonymous_votes' => [
                'text' => 'Permettre le vote anonyme individuel',
                'context' => 'Label for allowing participants to choose anonymity for their own vote.',
            ],
            'decisions.vote.field.allow_anonymous_votes_help' => [
                'text' => 'Les personnes qui souhaitent rester anonymes peuvent le choisir. Leur nom ne sera jamais affiché dans les résultats.',
                'context' => 'Help for the individual anonymous vote option.',
            ],
            ...
            'decisions.vote.field.named' => [
                'text' => 'Vote nominatif',
                'context' => 'Label for enabling a named vote.',
            ],
            ...
            'decisions.vote.action.configure' => [
                'text' => 'Configurer',
                'context' => 'Button label opening the simple vote settings popup.',
            ],
...
if (!function_exists('omoDecisionVoteModuleRender')) {
    function omoDecisionVoteModuleRender(array $renderContext)
    {
        ...
        $consultationOnly = !empty($renderContext['consultationOnly']);
        ...
        $consultationOnly = $consultationOnly
            || ($decisionGroup instanceof DecisionGroup
                && DecisionProcess::normalizeEvaluationMethod($decisionGroup->get('evaluation_method')) === DecisionProcess::METHOD_CONSULTATION_ONLY)
            || (!($decisionGroup instanceof DecisionGroup)
                && $decision instanceof DecisionProcess
                && DecisionProcess::normalizeEvaluationMethod($decision->get('evaluation_method')) === DecisionProcess::METHOD_CONSULTATION_ONLY);
        ...
        $isParticipateMode = $intent === 'participate' && !$consultationOnly;
        ...
        if ($consultationOnly) {
            $decisionType = DecisionProcess::TYPE_CONSULTATION;
        }
        ...
        $voteConfig = $consultationOnly
            ? ($decisionGroup instanceof DecisionGroup ? omoDecisionConsultationOnlyBuildConfig($decisionGroup) : omoDecisionConsultationOnlyBuildConfig([]))
            : ($decisionGroup instanceof DecisionGroup ? omoDecisionVoteBuildConfig($decisionGroup) : omoDecisionVoteBuildConfig([]));
        ...
        if ($decision instanceof DecisionProcess) {
            $submittedResponses = $decisionGroup instanceof DecisionGroup
                ? $decisionGroup->getResponses(DecisionResponse::STATUS_SUBMITTED)
                : $decision->getResponses(DecisionResponse::STATUS_SUBMITTED);
        ...
        <section class="omo-decision-vote<?= $isManageMode && !$embeddedQuestion ? '' : ' generic-section generic-section--stack' ?>">
            ...
            <?php if ($isManageMode): ?>
                ...
                <div class="generic-soft-panel generic-soft-panel--stack omo-decision-vote__notice">
                    <p class="omo-decision-vote__text"><?= $escape(t('decisions.vote.notice.consultation_only', [], $lang, $sourceLang)) ?></p>
                </div>
                <?php endif; ?>
                <?php if ($coreLocked): ?>
                <div class="generic-soft-panel generic-soft-panel--stack omo-decision-vote__notice">
                ...
                >
                    ...
                    <label class="generic-form-field omo-decision-vote__field">
                        <span class="generic-form-label"><?= $escape(t('decisions.vote.field.process_title', [], $lang, $sourceLang)) ?></span>
                        <input
                            type="text"
                            name="process_title"
                    ...
                    <label class="generic-form-field omo-decision-vote__field">
                        <span class="generic-form-label"><?= $escape(t('decisions.vote.field.process_description', [], $lang, $sourceLang)) ?></span>
                        <textarea
                    ...
                    <div class="generic-form-field omo-decision-vote__field">
                        <div class="generic-heading-with-help">
                            <label class="generic-form-label" for="omo-decision-vote-visibility"><?= $escape(t('decisions.edit.visibility.label', [], $lang, $sourceLang)) ?></label>
                        ...
                        <select name="visibility_type" id="omo-decision-vote-visibility" class="generic-form-control generic-form-control--compact" <?= $canEditStructure ? '' : 'disabled' ?>>
                        ...
                        <label class="generic-form-field omo-decision-vote__field">
                            <span class="generic-form-label"><?= $escape(t('decisions.vote.field.status', [], $lang, $sourceLang)) ?></span>
                            <select name="status" class="generic-form-control generic-form-control--compact" <?= $isEditable ? '' : 'disabled' ?>>
                                ...
                                <?php if ($consultationOnly && !in_array($statusKey, [DecisionProcess::STATUS_DRAFT, DecisionProcess::STATUS_SCHEDULED, DecisionProcess::STATUS_CONSULTATION], true)) continue; ?>
                    ...
                    <label class="generic-form-field omo-decision-vote__field">
                        <span class="generic-form-label"><?= $escape(t('decisions.vote.field.title', [], $lang, $sourceLang)) ?></span>
                        <input
                            type="text"
                            name="title"
                            class="generic-form-control generic-form-control--compact"
                    ...
                    <label class="generic-form-field omo-decision-vote__field">
                        <span class="generic-form-label"><?= $escape(t('decisions.vote.field.description', [], $lang, $sourceLang)) ?></span>
                        <textarea
                            name="description"
                            class="generic-form-control generic-form-control--compact omo-decision-vote__textarea"
                            rows="4"
                    ...
                    <div class="omo-decision-vote__grid">
                        ...
                        <?php if (!$consultationOnly): ?>
                        <label class="generic-form-field omo-decision-vote__field">
                            <span class="generic-form-label"><?= $escape(t('decisions.vote.field.type', [], $lang, $sourceLang)) ?></span>
                    ...
                    <div class="generic-form-field omo-decision-vote__field">
                        <div class="omo-decision-settings-title-row">
                            <span class="generic-form-label"><?= $escape(t($embeddedQuestion ? 'decisions.vote.field.question_settings' : 'decisions.vote.field.settings', [], $lang, $sourceLang)) ?></span>
                            <button
                                type="button"
                                ...
                                data-omo-decision-vote-settings-title="<?= $escape(t($embeddedQuestion ? 'decisions.vote.field.question_settings' : 'decisions.vote.field.settings', [], $lang, $sourceLang)) ?>"
                            >
                        ...
                        >
                        <div class="omo-decision-vote__settings-head omo-decision-settings-head">
                            <div class="generic-form-field omo-decision-vote__field">
                                    ...
                                    <section class="generic-section generic-section--stack generic-form-section generic-form-section--divided generic-form-section--compact">
                                        ...
                                        <div class="omo-decision-vote-popup__choice-grid">
                                            <label class="omo-decision-vote-popup__field">
                                                <span class="generic-form-label"><?= $escape(t('decisions.vote.field.choice_mode', [], $lang, $sourceLang)) ?></span>
                                                <select class="generic-form-control generic-form-control--compact" data-omo-decision-vote-popup-choice-mode <?= $canEditStructure ? '' : 'disabled' ?>>
                                            ...
                                            <label class="omo-decision-vote-popup__field" data-omo-decision-vote-popup-max-choices-field hidden>
                                                <span class="generic-form-label"><?= $escape(t('decisions.vote.field.max_choices', [], $lang, $sourceLang)) ?></span>
                                                <input type="number" min="0" class="generic-form-control generic-form-control--compact" data-omo-decision-vote-popup-max-choices <?= $canEditStructure ? '' : 'disabled' ?>>
                                            </label>
                                        </div>
                                    </section>
                                    <?php endif; ?>
                                    ...
                                    <span class="omo-decision-settings-popup__group-title"><?= $escape(t('decisions.edit.settings.privacy', [], $lang, $sourceLang)) ?></span>
                                        <div class="omo-decision-settings-popup__options">
                                            ...
                                            <label class="omo-decision-settings-popup__option omo-decision-settings-popup__option--wide">
                                                <input type="checkbox" data-omo-decision-vote-popup-owner-intermediate-results <?= $ownerIntermediateResultsAccess ? 'checked' : '' ?> <?= $canEditStructure ? '' : 'disabled' ?>>
                                                <span><?= $escape(t('decisions.edit.owner_intermediate_results_access_explicit', [], $lang, $sourceLang)) ?></span>
                                            </label>
                                            <label class="omo-decision-settings-popup__option omo-decision-settings-popup__option--wide">
                                                <input type="checkbox" data-omo-decision-vote-popup-participant-intermediate-results <?= $participantIntermediateResultsAccess ? 'checked' : '' ?> <?= $canEditStructure ? '' : 'disabled' ?>>
                                                <span><?= $escape(t('decisions.edit.participant_intermediate_results_access', [], $lang, $sourceLang)) ?></span>
                                            </label>
                                            <label class="omo-decision-settings-popup__option omo-decision-settings-popup__option--wide">
                                                <input type="checkbox" data-omo-decision-vote-popup-participant-responses-editable <?= $participantResponsesEditable ? 'checked' : '' ?> <?= $canEditStructure ? '' : 'disabled' ?>>
                                                <span><?= $escape(t('decisions.edit.participant_responses_editable', [], $lang, $sourceLang)) ?></span>
                                            </label>
                                            </div>
                                            <?php endif; ?>
                    ...
                    <div class="generic-form-field omo-decision-vote__field">
                        <div class="generic-heading-with-help">
                            <span class="generic-form-label"><?= $escape(t('decisions.vote.field.proposals', [], $lang, $sourceLang)) ?></span>
                            <details class="generic-context-help">
                                <summary aria-label="<?= $escape(t('decisions.vote.field.proposals_hint', [], $lang, $sourceLang)) ?>">?</summary>
                                <div class="generic-context-help__content"><?= $escape(t('decisions.vote.field.proposals_hint', [], $lang, $sourceLang)) ?></div>
                            </details>
                        </div>
                        <div class="omo-decision-vote__proposal-list" data-omo-decision-vote-proposal-list>
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    class="omo-decision-vote__proposal-drag generic-drag-handle generic-drag-handle--stretch"
                                ...
                                <div class="omo-decision-vote__proposal-main">
                                    ...
                                    <div data-omo-proposal-html-field>
                                        <div class="omo-proposal-html-editor" data-omo-proposal-html-editor data-omo-decision-vote-proposal-description-editor<?= $canEditProposals ? '' : ' data-omo-proposal-html-disabled="1"' ?>></div>
                                        <textarea hidden aria-hidden="true" name="proposal_descriptions[]" data-omo-proposal-html-value data-omo-decision-vote-proposal-description><?= $escape((string)($proposalItem['description'] ?? '')) ?></textarea>
                                    </div>
                                    <?php else: ?>
                            ...
                            aria-label="<?= $escape(t('decisions.vote.field.proposal_actions', [], $lang, $sourceLang)) ?>"
                                    ...
                                    <div class="omo-decision-vote__proposal-menu-panel omo-decision-proposal-menu-panel generic-soft-panel" data-omo-decision-vote-proposal-menu-panel role="menu" hidden>
                                        <?php if ($proposalContentUrlEnabled): ?><button
                                            type="button"
            ...
            <?php else: ?>
                ...
                <div class="omo-decision-vote__summary-grid">
                    ...
                    <?= omoDecisionModuleRenderReadonlyMeta(t('decisions.vote.field.consultation_end', [], $lang, $sourceLang), $decision instanceof DecisionProcess ? omoDecisionVoteFormatDateTimeLocal($decision->get('consultation_end_at')) : '', $escape, 'omo-decision-vote__meta-card') ?>
                    <?php else: ?>
                    <?= omoDecisionModuleRenderReadonlyMeta(t('decisions.vote.field.status', [], $lang, $sourceLang), t('decisions.vote.option.status.' . $status, [], $lang, $sourceLang), $escape, 'omo-decision-vote__meta-card') ?>
                    ...
                    <?php endif; ?>
                    <?= omoDecisionModuleRenderReadonlyMeta(t('decisions.vote.field.named', [], $lang, $sourceLang), !$isAnonymous ? t('decisions.vote.option.common.yes', [], $lang, $sourceLang) : t('decisions.vote.option.common.no', [], $lang, $sourceLang), $escape, 'omo-decision-vote__meta-card') ?>
                    <?= omoDecisionModuleRenderReadonlyMeta(t('decisions.vote.field.allow_consultation_proposals', [], $lang, $sourceLang), $allowConsultationProposals ? t('decisions.vote.option.common.yes', [], $lang, $sourceLang) : t('decisions.vote.option.common.no', [], $lang, $sourceLang), $escape, 'omo-decision-vote__meta-card') ?>
                    <?= omoDecisionModuleRenderReadonlyMeta(t('decisions.vote.field.allow_proposal_discussions', [], $lang, $sourceLang), $allowProposalDiscussions ? t('decisions.vote.option.common.yes', [], $lang, $sourceLang) : t('decisions.vote.option.common.no', [], $lang, $sourceLang), $escape, 'omo-decision-vote__meta-card') ?>
                ...
                <div class="omo-decision-vote__form generic-form-stack generic-form-stack--compact">
                <?php else: ?>
                <form
                    class="omo-decision-vote__form generic-form-stack generic-form-stack--compact"
                ...
                <section class="generic-soft-panel generic-soft-panel--stack">
                    <span class="generic-form-label"><?= $escape(t('decisions.vote.field.live_results_heading', [], $lang, $sourceLang)) ?></span>
                    ...
                    <?php
                    if (omoDecisionResponseIsAnonymous($liveResponse, omoDecisionVoteGetMethodKey())) continue;
                    ...
                    ?>
                    <?php if ($liveName !== '' && count($liveTitles) > 0): ?><div class="omo-decision-vote__readonly-stat"><strong><?= $escape($liveName) ?></strong><span><?= $escape(implode(' · ', $liveTitles)) ?></span></div><?php endif; ?>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </section>
                <?php endif; ?>
        ...
        <?= commonPageScriptTags('/omo/api/decision/modules/vote/module.js', [
    'isConsultationOnly' => ($consultationOnly),
]) ?>

        <link rel="stylesheet" href="<?= commonAssetUrl('/omo/api/decision/modules/vote/module.css') ?>">
        <?php endif; ?>
        <?php
    }
}
