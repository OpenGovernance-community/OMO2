...
if (!$coreLocked && count($proposalItems) < 1) {
    omoDecisionModuleJsonResponse(400, [
        'status' => false,
...
try {
    ...
    $decisionGroup->set('evaluation_method', DecisionProcess::METHOD_CONSENT);
...
omoDecisionModuleJsonResponse(200, [
    ...
    'redirectUrl' => omoDecisionBuildEditorUrl($organizationId, $targetHolonId, $decisionId, DecisionProcess::METHOD_CONSENT, 'manage', $decisionGroupId),
