...
$baseSourceLang = [
    ...
    'decisions.edit.participate_title' => [
        'text' => 'Participer à la prise de décision',
        'context' => 'Drawer title when opening a decision in participation mode.',
    ],
    ...
    'decisions.edit.choose_text' => [
        'text' => 'Commencez par sélectionner la manière d’évaluer cette prise de décision. Le flux de création détaillé dépend ensuite du module choisi.',
    ...
    'decisions.edit.method.consent.description' => [
        'text' => 'Une proposition est retenue tant qu’aucune objection bloquante n’est posée.',
    ...
    'decisions.edit.unsupported_text' => [
        'text' => 'Ce mode est bien prévu dans l’architecture, mais son écran de création détaillé n’est pas encore branché.',
...
if (!empty($context['decision']) && $context['decision'] instanceof DecisionProcess) {
    ...
    $requestedMethod = trim((string)$_GET['method']);
...
$selectedLabel = $selectedDefinition
    ...
    : '';
$showPageHeader = $intent !== 'participate';
$pageTitle = $isEditing
    ? ($intent === 'participate'
        ? t('decisions.edit.participate_title', [], $lang, $baseSourceLang)
        : ($intent === 'view'
            ? t('decisions.edit.view_title', [], $lang, $baseSourceLang)
            : t('decisions.edit.edit_title', [], $lang, $baseSourceLang)))
    : t('decisions.edit.create_title', [], $lang, $baseSourceLang);
?>
<div class="omo-decision-edit omo-panel-view">
...
(function () {
    function openEditorUrl(url, title) {
        ...
        if (typeof window.omoDecisionOpenNestedDrawer === 'function') {
            window.omoDecisionOpenNestedDrawer(title || 'Prises de décision', url, '');
            return;
        }

        if (typeof window.commonTopbarOpenDrawer === 'function') {
            window.commonTopbarOpenDrawer(title || 'Prises de décision', url, 'fetch');
            return;
        }
    ...
    document.querySelectorAll('[data-omo-decision-editor-link]').forEach(function (link) {
        ...
        link.addEventListener('click', function (event) {
            ...
            openEditorUrl(
                ...
                link.getAttribute('data-omo-decision-editor-title') || 'Prises de décision'
            );
        });
    });
})();
