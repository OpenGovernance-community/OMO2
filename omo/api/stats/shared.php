...
if (!function_exists('omoStatsSourceLang')) {
    function omoStatsSourceLang()
    {
        return [
            ...
            'stats.form.responsible_help' => ['text' => 'Si aucune personne n est choisie, la responsabilité reste portée par le rôle ou espace associé.', 'context' => 'Help text for the indicator responsible user selector.'],
