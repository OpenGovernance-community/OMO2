...
<?= commonPageScriptTags('/omo/api/stats/edit.js', [
    ...
    'saveError' => omoStatsT('stats.error.save'),
    'editorSaving' => $editT('editor.saving'),
    'editorSaved' => $editT('editor.saved'),
    'labels' => [
    ...
    'measurementScheduleOptions' => $measurementScheduleOptions,
]) ?>
